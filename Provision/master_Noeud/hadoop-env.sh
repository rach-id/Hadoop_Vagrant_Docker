...
#
# a) Set JMX options
# export HDFS_NAMENODE_OPTS="-Dcom.sun.manag/Users/chamirachid/Desktop/untitled folder/lab1- Install - Cluster/master_Noeud/hdfs-site.xmlement.jmxremote=true -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.port=1026"
#
